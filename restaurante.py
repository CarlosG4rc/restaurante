...
def agregar_categoria():
    ...
    try:
        ...
        print("La categoria '{}' ha sido creada correctamente".format(categoria))
...
def agregar_plato():
    ...
    try:
        ...
        print("El plato '{}' ha sido creado correctamente".format(plato))
...
#Menu de pciones del programa

while True:
    print("\n Bienvenido al gestor des restaurante")
